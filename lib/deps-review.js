...
function fetchPackageMetadata(cwd, dependency, metadataConfig, options = {}) {
  ...
  if (cached) {
    return metadataAnalysis(dependency, cached.json, { source: 'cache', url, metadataConfig, cwd, options, previousDependency: options.previousDependency });
  }
  ...
  return metadataAnalysis(dependency, response.json, { source: 'network', url, metadataConfig, cwd, options, previousDependency: options.previousDependency });
}
