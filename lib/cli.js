...
const commandGroups = [
  {
    ...
    commands: [
      ['execfence run [--sandbox] [--sandbox-mode audit|enforce] [--allow-degraded] [--record-artifacts] [--deny-on-new-executable] [--dependency-behavior-audit] -- <command>', 'Scan before running a command, then write runtime evidence.'],
  ...
  },
  {
    ...
    commands: [
      ...
      ['execfence guard global-status', 'Show global npm/pnpm/yarn shim status, real command resolution, and profile coverage.'],
      ['execfence guard global-enable', 'Install global skill/rules plus reversible npm/pnpm/yarn shims.'],
  ...
  },
  {
    ...
    commands: [
      ...
      ['execfence deps review [--base-ref <ref>] [--format text|json] [--package-manager auto|npm|pnpm|yarn]', 'Review changed npm/pnpm/yarn packages with guarded metadata checks.'],
  ...
  },
  {
    ...
    commands: [
      ...
      ['execfence sandbox install-helper|uninstall-helper|helper-audit', 'Manage or audit verified helper metadata.'],
...
function depsCommand(args) {
  ...
  throw new Error('Usage: execfence deps diff|review [--base-ref <ref>] [--format text|json] [--package-manager auto|npm|pnpm|yarn]');
}
