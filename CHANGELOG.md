...
- Added `docs/npm-supply-chain-assessment.md` to map public npm supply-chain incidents from 2025-05-06 through 2026-05-06 to ExecFence controls, gaps, and roadmap items.
